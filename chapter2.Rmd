...
Below you can find a summary of the data produced by describe from the psych-library. After this I examined the data visually.
...
Residuals vs fitted plot show us that the assumption of linear association is reasonable. Q-Q plot affirms us the assumption of normality, notwithstanding that a few outliers emerge. However, no observations exceed the measure of Cook's distance as seen in Residuals vs. leverage plot. According to these diagnostics, the LM assumption of Points ~ Attitude is valid.
